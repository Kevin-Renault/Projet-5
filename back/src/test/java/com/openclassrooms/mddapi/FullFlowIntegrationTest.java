...
class FullFlowIntegrationTest {
    ...
    private static HttpHeaders headersNoCookie() {
    ...
    private void captureCsrf(HttpHeaders headers) {
    ...
    private static String extractCookieIfPresent(HttpHeaders headers, String cookieName) {
        List<String> setCookieHeaders = headers.get(HttpHeaders.SET_COOKIE);
        if (setCookieHeaders == null || setCookieHeaders.isEmpty()) {
            return null;
        }
